...
// Utility for merging class names, a common pattern with Shadcn UI
...
const LoginPageContainer = () => {
  ...
  // Mock user data for demonstration of RBAC
  const mockUsers = [
  ...
  const onSubmit = (values: FormValues) => {
    ...
    // Find a matching user in our mock data
    ...
    if (user) {
      ...
      setMessage(`Login successful! Redirecting to ${user.role} dashboard...`);

      // In a real application, you would perform a redirection here based on the role.
    } else {
        ...
        <div className="flex flex-1 items-center justify-center p-4 md:p-8">
          <Card className="w-full max-w-sm rounded-2xl border-gray-300 dark:border-gray-800 bg-zinc/90">
            <CardHeader className="flex flex-col items-center p-6">
              <LogIn size={48} className="text-green-600 dark:text-green-500 mb-2" />
              <CardTitle className="text-2xl font-bold text-green-600 dark:text-green-500">Sign in to your account</CardTitle>
            ...
            <CardContent className="space-y-6 p-6 pt-0">
              <Form {...form}>
                <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4">
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        <FormLabel className="text-green-600 dark:text-green-500">Email</FormLabel>
                        <FormControl>
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        <FormLabel className="text-green-600 dark:text-green-500">Password</FormLabel>
                        <FormControl>
                          <div className="relative">
                  ...
                  {/* Login Button */}
                  <Button type="submit" className="w-full bg-green-600 hover:bg-green-700 text-white font-thin">
                    Sign in
                  </Button>
                </form>
              </Form>
              ...
              <div className="text-center text-sm text-gray-600 dark:text-gray-400">
                <a href="#" className="font-medium text-green-600 dark:text-green-500 hover:text-green-700 dark:hover:text-green-400">
              ...
              {message && (
                <div className="text-center text-sm font-thin">
                  <p className={userRole ? 'text-green-600 dark:text-green-500' : 'text-red-500'}>
                    {message}
                  </p>
                </div>
              )}
